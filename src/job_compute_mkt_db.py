...
from compute.breadth import compute_breadth
from compute.compute import (
    cal_dispersion_score,
    cal_stocks_rs,
    gen_long_scanner_data,
...
from config.website import NSEConfig
from ingest import fetch_nse_indices
...
if __name__ == "__main__":
    ...
    scanner_df_dict = gen_long_scanner_data(
        stocks_df=stocks_df,
        nse_ind_df=nse_ind_df,
