...
from compute.filter import (
    adr_filter,
    basic_long_filter,
    basic_short_filter,
    pullback_filter,
)
from compute.scanner import (
    basic_long_scan,
    basic_short_scan,
    find_stocks,
    prep_scan_data,
...
from config.compute import ComputeConfig, IndicatorConfig
...
def gen_long_scanner_data(
    ...
    basic_scan_df = basic_long_scan(data=scan_df)
    ...
    basic_filter_df = basic_long_filter(
